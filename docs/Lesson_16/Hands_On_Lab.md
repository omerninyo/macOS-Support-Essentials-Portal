...
**תרחיש "חדר הבריחה":** משתמש קצה טוען שהוא לא מקבל פרופילים ופקודות מה-MDM הארגוני. כאיש IT, אתם חושדים שה-Firewall הארגוני חוסם את התקשורת של המק לשרתי אפל (APNs בפורט 5223). עליכם לספק הוכחה חותכת מתוך הלוגים לצוות ה-Network כדי שישחררו את החסימה.
