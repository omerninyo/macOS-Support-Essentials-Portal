...
* **Accessory Security (אבטחת אביזרים):** מנגנון אבטחה ב-Mac עם Apple Silicon הדורש אישור מפורש של המשתמש לפני שאביזרי USB או Thunderbolt (או כרטיסי SD) מורשים לתקשר עם המערכת. ניתן לניהול דרך System Settings -> Privacy & Security או דרך פרופילי MDM.
