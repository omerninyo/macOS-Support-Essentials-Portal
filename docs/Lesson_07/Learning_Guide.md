...
> **📌 פיילוט בלבד** — הקובץ המקורי שמור ללא שינוי.
...
> [!IMPORTANT]
> **הצפנת כונן הגיבוי:** כונן לא מוצפן שנישא בתיק מהווה פרצת אבטחה אדירה. לעולם אל תגבו לאמצעי חיצוני ללא הפעלת Encrypt Backup!
...
> [!CAUTION]
> **שמות חשבונות (Account Names):** אסור ליצור חשבון זמני (למשל, בשם "john") במחשב החדש, ואז לנסות להגר את החשבון המקורי "john" מגיבוי ה-Time Machine שלכם (בעזרת Migration Assistant). זה ייצור התנגשות מערכתית נוראית.
