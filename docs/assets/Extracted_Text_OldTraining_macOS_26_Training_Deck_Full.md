# Extracted Text: OldTraining_macOS_26_Training_Deck_Full
...
## Slide 12
- Second-generation 3-nanometer process
...
## Slide 24
- All-day business productivity with M4
...
## Slide 28
- World’s best all-in-one for AI
...
## Slide 36
- Extensive external display support
...
## Slide 39
- Run the largest LLMs locally with M3 Ultra
...
## Slide 58
- מעבדי Intelligent actions in Shortcuts
...
## Slide 82
- macOS Advanced
- סביבת השחזור (Recovery) Intro
- סביבת Recovery
- מעבדי Intel vs Apple Silicon
- סביבת השחזור (Recovery) Tools
- On Screen
- Menu Tools
- Recovering Recovery
- Startup Security
...
## Slide 85
- macOS Advanced Settings Exercise
- Command Line Interface
...
- Using Disk Utility
- סביבת השחזור (Recovery) Partition/Volume
