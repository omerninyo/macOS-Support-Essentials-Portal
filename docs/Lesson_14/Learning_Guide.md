...
> [!IMPORTANT]
> **אזהרה פעולית:** `EraseDevice` דורשת שה-Mac מחובר לאינטרנט ברגע קבלת הפקודה. מק ללא חיבור רשת — הפקודה לא תבצע. בנוסף, אם המק ננעל ב-Activation Lock לאחר המחיקה — AppleCare דורשת הוכחת רכישה (חשבונית) לשחרור ידני.
