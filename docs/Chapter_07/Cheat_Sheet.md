# Chapter 07 Asset C: סיכום שיעור (Time Machine & Snapshots)
...
* **Backup Destination (יעד הגיבוי):** הכונן החיצוני (כונן USB, Thunderbolt, NAS, או שרת SMB תואם Time Machine) שמוגדר לאחסון הגיבוי. החל מ-macOS Big Sur, יעדי הגיבוי מפורמטים אוטומטית למערכת הקבצים APFS.
