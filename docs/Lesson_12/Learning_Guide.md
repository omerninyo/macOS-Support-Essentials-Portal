...
!!! note "הערה טכנית (Snapshots)"
    מדוע שדרוג ששוקל 5 ג'יגה דורש לעיתים 40 ג'יגה פנויים? כדי להבטיח התקנה בטוחה, ה-OS (דרך מנגנון ה-SSV) מבצע צילום מצב של הדיסק לפני העדכון. אם נופלת רשת או חשמל, המערכת חוזרת לנקודת ההתחלה מבלי שיינזק מידע!
