...
5. בחלון הקופץ תישאל כיצד תרצה לשחזר גישה במקרה שתשכח סיסמה. בחר באפשרות יצירת Recovery Key מקומי (Create a recovery key and do not use my iCloud account).
   *הערה: ב-macOS Tahoe, במידה ואתה מחובר ל-Apple Account ושרשרת המפתחות מופעלת בענן, ייתכן שהמערכת תבחר בגיבוי ל-iCloud אוטומטית. לצורך תרגול זה, הקפד לבחור בייצור מפתח PRK מקומי.*
