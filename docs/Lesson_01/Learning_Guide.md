...
* **Setup Assistant:** התהליך הראשוני שמתבצע בהפעלת מק חדש או אחרי EACS. אחראי על הגדרות רשת, אזור, יצירת Local Account, ועוד. ב-macOS 26 Tahoe תהליך זה גם מוריד מאובטחת את מודלי השפה של Apple Intelligence.
